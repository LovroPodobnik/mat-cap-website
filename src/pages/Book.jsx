    ...
    <motion.div {...pageTransition}>
      <PageContainer>
        {!isExpanded && (
          <StaggerContainer>
            ...
            <Paragraph align="center">
              Izpolnite spodnji obrazec in se dogovorite za termin tetoviranja
            </Paragraph>
          </StaggerContainer>
        )}
        ...
        <FormContainer
          ref={formRef}
          initial={false}
          animate={isExpanded ? expandAnimation.expanded : expandAnimation.animate}
          $isExpanded={isExpanded}
        >
          <AnimatePresence>
            {isExpanded && (
          ...
          <ExpandedContent $isExpanded={isExpanded}>
            {isExpanded && (
              ...
              >
                <H1 align="center">Dogovorite se za termin</H1>
                <Paragraph align="center" style={{ marginBottom: '2rem' }}>
                  Izpolnite spodnji obrazec in se dogovorite za termin tetoviranja
                </Paragraph>
              </motion.div>
            )}
            ...
            <SuccessContent>
              ...
              >
                ...
                <CloseSuccessButton
                  ...
                  initial={{ opacity: 0, y: 20 }}
                  animate={{ opacity: 1, y: 0 }}
                  transition={{ delay: 0.9 }} // Delayed more to appear after social links
